...
#namespace("sm_sys_user")
	#sql("admin-paginate")
		select id,name,avatar,password,account,sex,career,area,userType,mobile,email,freezeDate,freezeCause,status,createDate,lastLoginDate,ifnull(fa.followers ,0) as followers, ifnull(fu.followings ,0) as followings
